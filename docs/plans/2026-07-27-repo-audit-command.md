...
> **Status:** design spec, not yet approved for implementation. Resolves issue [#616](https://github.com/terrygzhou/arc-kit/issues/616) ("audit with codebase in github and/or gitlab").
