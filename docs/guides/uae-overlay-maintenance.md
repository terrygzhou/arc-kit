...
To apply: open an issue tagged `uae-overlay` and `co-maintainer` on the [arc-kit](https://github.com/terrygzhou/arc-kit) repository, with a short note on background and proposed time commitment.
