...
- **`product-architecture.json`** — Product architecture schema (shared with `/arckit:product-architecture`)

- **`vision.yaml`** — Architecture vision (shared with `/arckit:oaa-adm-lite`, `/arckit:adm-preliminary`)
