...
- `/arckit:discovery` — Current-state baseline: strategy, capabilities, applications, data, technology, constraints
...
- `/arckit:data-architecture` — Phase C.2 Data Architecture: data entities, governance framework, master/reference data
- `/arckit:technology-architecture` — Phase D Technology Architecture: infrastructure, platform, network, deployment
