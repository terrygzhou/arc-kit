...
Initial release of `arckit-uk-nhs` — UK NHS Clinical Safety + Medical Device Regulation overlay. First **sector-specific** ArcKit community overlay (existing overlays are jurisdiction-specific). Closes part of [#424](https://github.com/terrygzhou/arc-kit/issues/424).
...
**Spec doc:** [`docs/superpowers/specs/2026-05-19-uk-nhs-overlay-design.md`](https://github.com/terrygzhou/arc-kit/blob/main/docs/superpowers/specs/2026-05-19-uk-nhs-overlay-design.md) — decision log for review by @pacharanero.
